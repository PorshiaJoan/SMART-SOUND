    ...
    def update_video_display(self, dt):
        if not pause_detection:
            ...
            if current_state == PERSON_DETECTION:
                ...
                list = []
                countperson = 0
                # Calculate the center of the screen for the green line
                ...
                for index, row in px.iterrows():
                    ...
                    if 'person' in c:
                        ...
                        center_x = (x1 + x2) // 2
                        # Check if the center of the person is to the left or right of the green line
                        if center_x < cx1:
                            left_of_green_line += 1
                        elif center_x > cx1:
                            right_of_green_line += 1

                # Display the counts of people to the left and right of the green line
                ...
                if countperson >= 0:
                    ...
                    if current_volume_db < -63:
                        ...
                        with open('C:\\Users\\Porshia Joan\\OneDrive\\Desktop\\yolov8peoplecounter-main\\data.csv', 'a') as f:
